...
echo "íº€ Setting up server 113.173.154.153 for Real-Time Employee Task Management Tool..."
...
# Install Node.js 18
echo "í³¦ Installing Node.js 18..."
curl -fsSL https://deb.nodesource.com/setup_18.x | sudo -E bash -
sudo apt-get install -y nodejs

# Install PM2 globally
echo "í³¦ Installing PM2 process manager..."
...
echo "í³¦ Installing server dependencies..."
cd server
npm install
...
echo "íº€ Starting application with PM2..."
pm2 start ecosystem.config.js

# Save PM2 configuration
echo "í²¾ Saving PM2 configuration..."
pm2 save
pm2 startup

# Open firewall ports
echo "í´¥ Configuring firewall..."
sudo ufw allow 22
sudo ufw allow 80
sudo ufw allow 4000
...
echo ""
echo "í¼ Your API server is now running at:"
